...
describe('HomePage Component', () => {
    ...
    it('renders the home page', () => {
        render(<BrowserRouter>
                <HomePage token={null} currentUser={null} showToast={mockShowToast} fetchPosts={mockFetchPosts}/>
            </BrowserRouter>);
    ...
    it('shows create post prompt when logged in', () => {
        render(<BrowserRouter>
                <HomePage token={mockToken} currentUser={mockCurrentUser} showToast={mockShowToast} fetchPosts={mockFetchPosts}/>
            </BrowserRouter>);
    ...
    it('shows empty state message when no posts', () => {
        render(<BrowserRouter>
                <HomePage posts={[]} token={mockToken} currentUser={mockCurrentUser} showToast={mockShowToast} fetchPosts={mockFetchPosts}/>
            </BrowserRouter>);
