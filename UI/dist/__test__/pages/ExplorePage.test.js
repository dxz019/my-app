...
describe('ExplorePage', () => {
    ...
    const renderPage = (route = '/explore') => render(<MemoryRouter initialEntries={[route]}>
            <Routes>
                <Route path="/explore" element={<ExplorePage posts={posts} token="token" currentUser={{ id: 1, username: 'ava' }} showToast={vi.fn()} fetchPosts={vi.fn()} requireAuth={vi.fn(() => true)}/>}/>
            </Routes>
        </MemoryRouter>);
