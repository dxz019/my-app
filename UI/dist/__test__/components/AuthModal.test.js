...
describe('AuthModal Component', () => {
    ...
    it('does not render when visible is false', () => {
        renderWithRouter(<AuthModal visible={false} onHide={mockOnHide} onLogin={mockOnLogin} onRegister={mockOnRegister} showToast={mockShowToast}/>);
    ...
    it('shows login form when visible', () => {
        renderWithRouter(<AuthModal visible={true} onHide={mockOnHide} onLogin={mockOnLogin} onRegister={mockOnRegister} showToast={mockShowToast}/>);
