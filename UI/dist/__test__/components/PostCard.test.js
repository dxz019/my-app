...
vi.mock('../../components/CommentSection', () => ({
    default: ({ postId, comments }) => (<div data-testid="comment-section">Comments: {comments.length}</div>),
}));
// Mock postsAPI
...
describe('PostCard Component', () => {
    ...
    it('hides delete button when user is not author', () => {
        ...
        renderWithRouter(<PostCard {...defaultProps} currentUser={differentUser}/>);
    ...
    it('renders comment section', () => {
        ...
        renderWithRouter(<PostCard {...propsWithComments}/>);
