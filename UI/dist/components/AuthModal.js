...
const AuthModal = ({ visible, onHide }) => {
    ...
    const footer = (<div className="flex justify-content-center gap-3 pt-3">
            <Button label="Login" className="p-button-outlined" style={{
            borderRadius: '24px',
    ...
    return (<Dialog visible={visible} onHide={onHide} header={null} footer={footer} style={{ width: '400px' }} closable className="auth-prompt-modal" contentStyle={{
            paddingTop: '2.5rem',
            textAlign: 'center',
