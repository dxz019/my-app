...
export default function Dashboard({ token, showToast }) {
    ...
    return (<div className="dashboard">
      ...
      {loading ? (<div className="flex justify-content-center py-6">
          <i className="pi pi-spin pi-spinner" style={{ fontSize: '2rem' }}></i>
        </div>) : stories.length === 0 ? (<div className="text-center py-6">
          ...
          {stories.map(story => (<div key={story._id} className="col-12 md:col-6 lg:col-4">
