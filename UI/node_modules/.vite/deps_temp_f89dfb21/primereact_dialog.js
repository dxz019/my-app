...
import {
  IconBase
} from "./chunk-TKRBMDJ6.js";
import {
  CSSTransition
} from "./chunk-NTCKD6SF.js";
import {
  Ripple
} from "./chunk-YZAVPR2H.js";
import {
  Portal
} from "./chunk-UM4USJ5Z.js";
...
var WindowMaximizeIcon = React2.memo(React2.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var WindowMinimizeIcon = React3.memo(React3.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var Dialog = React4.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React4.useState(uniqueId), _React$useState2 = _slicedToArray(_React$useState, 2), idState = _React$useState2[0];
  _React$useState2[1];
  var _React$useState3 = React4.useState(false), _React$useState4 = _slicedToArray(_React$useState3, 2), maskVisibleState = _React$useState4[0], setMaskVisibleState = _React$useState4[1];
  var _React$useState5 = React4.useState(false), _React$useState6 = _slicedToArray(_React$useState5, 2), visibleState = _React$useState6[0], setVisibleState = _React$useState6[1];
  var _React$useState7 = React4.useState(props.maximized), _React$useState8 = _slicedToArray(_React$useState7, 2), maximizedState = _React$useState8[0], setMaximizedState = _React$useState8[1];
  var dialogRef = React4.useRef(null);
  var maskRef = React4.useRef(null);
  var pointerRef = React4.useRef(null);
  var contentRef = React4.useRef(null);
  var headerRef = React4.useRef(null);
  var footerRef = React4.useRef(null);
  var closeRef = React4.useRef(null);
  var dragging = React4.useRef(false);
  var resizing = React4.useRef(false);
  var lastPageX = React4.useRef(null);
  var lastPageY = React4.useRef(null);
  var styleElement = React4.useRef(null);
  var attributeSelector = React4.useRef(uniqueId);
  ...
  var createCloseIcon = function createCloseIcon2() {
    if (props.closable && props.showCloseIcon) {
      ...
      var icon = props.closeIcon || React4.createElement(TimesIcon, closeButtonIconProps);
      ...
      return React4.createElement("button", closeButtonProps, headerCloseIcon, React4.createElement(Ripple, null));
    }
    return null;
  };
  var createMaximizeIcon = function createMaximizeIcon2() {
    ...
    if (!maximized) {
      icon = props.maximizeIcon || React4.createElement(WindowMaximizeIcon, maximizableIconProps);
    } else {
      icon = props.minimizeIcon || React4.createElement(WindowMinimizeIcon, maximizableIconProps);
    }
    ...
    if (props.maximizable) {
      ...
      return React4.createElement("button", maximizableButtonProps, toggleIcon, React4.createElement(Ripple, null));
    }
    return null;
  };
  var createHeader = function createHeader2() {
    if (props.showHeader) {
      ...
      return React4.createElement("div", headerProps, React4.createElement("div", headerTitleProps, header2), React4.createElement("div", headerIconsProps, icons, maximizeIcon, closeIcon));
    }
    return null;
  };
  var createContent = function createContent2() {
    ...
    return React4.createElement("div", contentProps, props.children);
  };
  var createFooter = function createFooter2() {
    ...
    return footer2 && React4.createElement("div", footerProps, footer2);
  };
  ...
  var createElement5 = function createElement6() {
    ...
    return React4.createElement(React4.Fragment, null, header2, content2, footer2, resizer);
  };
  var createDialog = function createDialog2() {
    ...
    var rootElement = React4.createElement("div", maskProps, React4.createElement(CSSTransition, _extends4({
      nodeRef: dialogRef
    }, transitionProps), React4.createElement("div", rootProps, React4.createElement(FocusTrap$1, {
