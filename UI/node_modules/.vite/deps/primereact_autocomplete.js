...
import {
  Button,
  SpinnerIcon
} from "./chunk-4B4NOJ52.js";
import {
  Ripple
} from "./chunk-YZAVPR2H.js";
import {
  OverlayService
} from "./chunk-6NBPJCUZ.js";
import {
  CSSTransition
...
import {
  InputText
} from "./chunk-AUEQFCS3.js";
import "./chunk-MCR3SN6Y.js";
import {
  Tooltip
} from "./chunk-WR7R2MJW.js";
import {
  Portal
...
var VirtualScroller = React3.memo(React3.forwardRef(function(inProps, ref) {
  ...
  var viewInitialized = React3.useRef(false);
...
var AutoCompletePanel = React4.memo(React4.forwardRef(function(props, ref) {
  var mergeProps = useMergeProps();
  ...
  var createLabelItem = function createLabelItem2(item2, key, index, labelItemProps) {
    ...
    return React4.createElement("li", _extends4({}, itemGroupProps, {
      key: key ? key : null
    }), content);
  };
  ...
  var createListItem = function createListItem2(item2, key, index, listItemProps) {
    ...
    return React4.createElement("li", _extends4({
      key
    }, itemProps), content, React4.createElement(Ripple, null));
  };
  ...
  var createContent = function createContent2() {
    if (props.showEmptyMessage && ObjectUtils.isEmpty(props.suggestions)) {
      ...
      return React4.createElement("ul", _listProps, React4.createElement("li", emptyMessageProps, emptyMessage));
    }
    if (props.virtualScrollerOptions) {
      ...
      var virtualScrollerProps = _objectSpread$1(_objectSpread$1({}, props.virtualScrollerOptions), {
        ...
        contentTemplate: function contentTemplate(options) {
          ...
          return React4.createElement("ul", listProps2, options.children);
        }
      });
    ...
    return React4.createElement("div", listWrapperProps, React4.createElement("ul", listProps, items));
  };
...
var AutoComplete = React4.memo(React4.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React4.useContext(PrimeReactContext);
  var props = AutoCompleteBase.getProps(inProps, context);
  var _React$useState = React4.useState(props.id), _React$useState2 = _slicedToArray2(_React$useState, 2), idState = _React$useState2[0], setIdState = _React$useState2[1];
  var _React$useState3 = React4.useState(false), _React$useState4 = _slicedToArray2(_React$useState3, 2), searchingState = _React$useState4[0], setSearchingState = _React$useState4[1];
  var _React$useState5 = React4.useState(false), _React$useState6 = _slicedToArray2(_React$useState5, 2), focusedState = _React$useState6[0], setFocusedState = _React$useState6[1];
  ...
  var multiContainerRef = React4.useRef(null);
  var virtualScrollerRef = React4.useRef(null);
  var timeout = React4.useRef(null);
  var selectedItem = React4.useRef(null);
  ...
  var createChips = function createChips2() {
    if (ObjectUtils.isNotEmpty(props.value)) {
      return props.value.map(function(val, index) {
        ...
        var icon = props.removeTokenIcon || React4.createElement(TimesCircleIcon, removeTokenIconProps);
        var removeTokenIcon = !props.disabled && IconUtils.getJSXIcon(icon, _objectSpread2({}, removeTokenIconProps), {
          props
        });
        ...
        return React4.createElement("li", _extends4({
          key
        }, tokenProps), React4.createElement("span", tokenLabelProps, formatValue(val)), removeTokenIcon);
      });
    }
  ...
  var createMultiInput = function createMultiInput2(allowMoreValues) {
    ...
    return React4.createElement("li", inputTokenProps, React4.createElement("input", inputProps));
  };
  var createMultipleAutoComplete = function createMultipleAutoComplete2() {
    ...
    return React4.createElement("ul", containerProps, tokens, input3);
  };
  var createDropdown = function createDropdown2() {
    if (props.dropdown) {
      ...
      return React4.createElement(Button, {
        type: "button",
        icon: props.dropdownIcon || React4.createElement(ChevronDownIcon, null),
  ...
  var createLoader = function createLoader2() {
    if (searchingState) {
      ...
      var loaderIcon = IconUtils.getJSXIcon(icon, _objectSpread2({}, loadingIconProps), {
        props
      });
      return loaderIcon;
    }
  ...
  return React4.createElement(React4.Fragment, null, React4.createElement("span", rootProps, input2, loader, dropdown, React4.createElement(AutoCompletePanel, _extends4({
