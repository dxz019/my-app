...
const ProfilePage = ({
    ...
    return (
        <div className="profile-wrapper w-full" style={{ paddingBottom: '3rem' }}>
            {/* Header Section */}
            <div 
                className="p-4 mb-4"
                style={{ 
                            ...
                            <div className="flex flex-column gap-4 max-w-25rem mx-auto md:mx-0">
                                 <div className="flex flex-column gap-2 mb-2">
                                    ...
                                    <InputText 
                                        ...
                                        className="p-inputtext-lg profile-edit-input"
                                        style={{ 
                                            background: '#ffffff', 
            ...
            {/* Content Tabs / Header */}
            <div className="flex align-items-center justify-content-between mb-5 px-3">
                <h3 className="text-2xl font-bold" style={{ color: 'var(--color-text-main)' }}>
                    {isOwnProfile ? 'Your Thoughts' : `Posts from @${displayUser.username}`}
                </h3>
                <span className="font-bold text-lg" style={{ color: 'var(--color-text-sub)' }}>{userPosts.length} posts</span>
            </div>

            <div className="p-4 mb-4" style={{ backgroundColor: 'var(--color-bg-card)', border: '1px solid var(--color-border)', borderRadius: '16px' }}>
            ...
            {userPosts.length === 0 && (
                <div className="text-center p-8 mt-6 surface-card border-round-3xl border-1 border-dashed border-700">
                    <i className="pi pi-cloud-upload text-700" style={{ fontSize: '4rem', marginBottom: '2rem' }}></i>
                    <p className="text-600 text-2xl font-light">{isOwnProfile ? "You haven't shared your thoughts yet." : "This user is still gathering their thoughts."}</p>
                    {isOwnProfile && !currentUser && (
                        <Button 
                            label="Start Sharing" 
