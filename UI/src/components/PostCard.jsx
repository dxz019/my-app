            ...
            <div className="flex-1">
                <div className="flex align-items-center flex-wrap gap-2">
                    ...
                    {isAuthor && (
                        <Button
                            icon="pi pi-trash"
                            className="p-button-text p-button-rounded p-button-sm p-button-plain ml-auto"
                    ...
                    <div className="mb-3">
                        <div className="grid grid-nogutter gap-2" style={{ maxHeight: '400px' }}>
                            {post.media.map((url, idx) => (
                                <div key={idx} className={`${post.media.length === 1 ? 'col-12' : 'col-5'} border-round-lg overflow-hidden flex-grow-1`}>
                                    <img
                                        src={getPublicUrl(url)}
                                        alt={`Post attachment ${idx + 1}`}
                                        className="w-full h-full"
                                        style={{ minHeight: post.media.length === 1 ? '300px' : '200px', objectFit: 'cover' }}
                                    />
                                </div>
                            ))}
                        </div>
